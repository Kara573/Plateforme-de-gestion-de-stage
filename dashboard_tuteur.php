    ...
    <main>
        <div class="dashboard-section">
            <div class="dashboard-item">
                ...
                <a href="profil_etudiant.php">Voir profil stagiaire</a>
            </div>
            <div class="dashboard-item">
                <i class="fas fa-check-circle"></i>
                <a href="candidatures_validees.php">Liste candidature validée</a>
            </div>
            <div class="dashboard-item">
                <i class="fas fa-envelope"></i> 
                <a href="candidatures_sollicitees.php">Candidatures sollicitées</a>
            </div>
            <div class="dashboard-item">
