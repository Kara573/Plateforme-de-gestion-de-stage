...
// Requête pour récupérer les sollicitations avec des informations supplémentaires
$sql = "SELECT st.id, t.nom AS tuteur_nom, e.prenom AS etudiant_prenom, e.nom AS etudiant_nom, 
               e.niveau_etude, e.filiere, e.ecole, st.date_solicitation 
        FROM SollicitationsTuteur st
        JOIN Tuteurs t ON st.tuteur_id = t.tuteur_id
...
<body>
    ...
    <div class="container">
        <div class="section">
            <h2>Liste des Candidatures Sollicitées</h2>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php foreach ($candidatures as $candidature): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($candidature['tuteur_nom']); ?></td>
