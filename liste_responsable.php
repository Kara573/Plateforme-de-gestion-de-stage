...
// Récupération des responsables de stage
$responsables = [];

try {
    $stmt = $pdo->query("SELECT nom, prenom, email FROM ResponsablesStage");
...
<head>
    ...
    <title>Liste des Responsables de Stage</title>
...
<body>
    <header>
        <h1>Liste des Responsables de Stage</h1>
    </header>
